...
urlpatterns = [
    ...
    path('payments/all/', views.complete_payment_list, name='complete_payment_list'),
    path('transactions/all/', views.complete_transaction_list, name='complete_transaction_list'),
    ...
    path(
        'trasaction_detail/<int:transaction_id>/pdf/', views.transaction_pdf, name='transaction_pdf'
    ),
